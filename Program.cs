...
namespace Practice_Linq
{
    public class Program
    {
        ...
        static void Query1(List<FootballGame> games)
        {
            ...
            var selectedGames = games.OrderBy(game => game.Date).Where(game => (game.Date.Year == 2012 && game.Country == "Ukraine"));
        ...
        static void Query4(List<FootballGame> games)
        {
            ...
            var selectedGames = games.OrderBy(game => game.Date).Where(game => game.Away_team == "Germany" && game.Home_score > game.Away_score && game.Date.Year >= 2018 && game.Date.Year <= 2020);
        ...
        static void Query5(List<FootballGame> games)
        {
            ...
            var selectedGames = games.OrderBy(game => game.Date).Where(game =>  (game.City == "Kyiv" || game.City == "Kharkiv") && (game.Home_team == "Ukraine" && game.Home_score > game.Away_score) && game.Tournament == "UEFA Euro qualification");
        ...
        static void Query7(List<FootballGame> games)
        {
            ...
            FootballGame? g = games.FirstOrDefault(game => game.Date.Year == 2023 && (game.Home_team == "Ukraine" || game.Away_team == "Ukraine") && (game.Home_team == "Ukraine" && game.Home_score > game.Away_score || game.Away_team == "Ukraine" && game.Away_score > game.Home_score));
